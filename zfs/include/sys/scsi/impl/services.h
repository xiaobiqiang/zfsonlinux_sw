...
#define	INTERCONNECT_HBX		12
#define	INTERCONNECT_CLUSTER	13
#define	INTERCONNECT_MAX		14	/* Change this appropriately, */
...
#define	INTERCONNECT_HBX_STR		"HBX"
#define	INTERCONNECT_CLUSTER_STR	"CLUSTER"
...
#define	INTERCONNECT_TYPE_ASCII		{				\
					...
					INTERCONNECT_HBX_STR,		\
					INTERCONNECT_CLUSTER_STR,	\
					NULL				\
					};

...
#define	MP_DRVR_TRANSPORT_TYPE_HBX	6
#define	MP_DRVR_TRANSPORT_TYPE_CLUSTER	7
...
typedef struct mp_target_port_prop {
	...
	uint32_t	slot_no; /* padding for 64bit alignment */
	uint64_t	id;
...
typedef struct mp_path_prop {
	...
	uint32_t			pathState;
	boolean_t			disabled;
	uint32_t			pathRole; /* 64bit alignment padding */
	uint64_t			id;

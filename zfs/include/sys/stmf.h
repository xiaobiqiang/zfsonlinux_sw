...
typedef enum
{
	FCT_QUEUE_SCSI_TASK_FOR_TERMINATION = 0,
	FCT_RESET_FLAG_ABORT_CALLED,
	ISCSIT_TASK_ABORTED,
	ISCSIT_OP_SCSI_TASK_MGMT,
	PPPT_SESS_CLOSE_LOCKED,
	SBD_PGR_OUT_PREEMPT,
	SBD_HANDLE_READ_XFER_COMPLETION,
	SBD_HANDLE_SGL_READ_XFER_COMPLETION,
	SBD_HANDLE_SGL_WRITE_XFER_COMPLETION,
	SBD_DO_WRITE_XFER,
	SBD_DO_STANDBY_WRITE_XFER,
	SBD_HANDLE_ACTIVE_WRITE_XFER_COMPLETION,
	SBD_HANDLE_STANDBY_WRITE_XFER_COMPLETION,
	SBD_HANDLE_ACTIVE_WRITE,
	SBD_HANDLE_STANDBY_WRITE,
	SBD_HANDLE_SHORT_READ_XFER_COMPLETION,
	SBD_HANDLE_SHORT_WRITE_TRANSFERS,
	SBD_HANDLE_SHORT_WRITE_XFER_COMPLETION,
	SBD_HANDLE_WRITE_SAME_XFER_COMPLETION,
	SBD_DO_WRITE_SAME_XFER,
	SBD_HANDLE_WRITE_SAME,
	SRPT_CH_CLEANUP,
	SRPT_CH_DATA_COMP,
	SRPT_CH_TASK_MGMT_ABORT,
	STMF_IC_RX_SCSI_DATA,
	STMF_DO_ILU_TIMEOUTS,
	STMF_SET_LU_ACCESS,
	STMF_SVC,
	STMF_DIRECT_POST_TASK,
	STMF_SCSILIB_HANDLE_REPORT_TPGS,
	STMF_HANDLE_LUN_RESET,
	STMF_HANDLE_TARGET_RESET,
	STMF_DLUN0_NEW_TASK,
	STMF_DLUN0_DBUF_DONE,
	STMF_LUN_RESET_POLL,
	STMF_TARGET_RESET_POLL,
	STMF_HANDLE_READ_CAPACITY,
	MAX_TASK_ABORT_TYPE
} TASK_ABORT_TYPE;


#define	STMF_CMD_DATA_SIZE_MAX	256*1024 /* 1024 * 1024 */
...
#define	STMF_RECV_DEACTIVE_MSG	0
#define	STMF_RECV_LINK_DOWN		1
...
#define	DB_LPORT_XFER_ACTIVE		0x0080
#define	DB_DONT_EMULATE_STATUS_GOOD	0x0100
#define	DB_TYPE_PPPT			0x0200
#define	DB_WRITE_META_DATA		0x0800
...
typedef struct scsi_task {
	...
	/* For proxy write support */
	uint8_t task_proxy_initiator_nbufs;
...
#define	TASK_AF_RESPONSD_RETRY		0x10
/*
 * PP sets this flag if it can process dbufs created by the LU.
 */
#define	TASK_PPPT_LU_DBUF		0x20
...
#define	STMF_PORT_LINK_UP	0x1
#define	STMF_PORT_LINK_DOWN	0x2
...
#define	STMF_CMD_SET_STATUS		0x0008
...
#define	STMF_CMD_SET_LU_STATUS	(STMF_CMD_LU_OP | STMF_CMD_SET_STATUS)
/*
...
scsi_task_t * stmf_find_and_hold_task(uint8_t *lu_id, uint64_t task_msgid);
...
void stmf_abort(int abort_cmd, scsi_task_t *task, stmf_status_t s,
	void *arg, uint32_t abort_type);

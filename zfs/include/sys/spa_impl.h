...
struct spa {
	...
	metaslab_class_t *spa_meta_class;  /* intent meta data class */
	metaslab_class_t *spa_low_class;	/* intent low data class */
	...
	spa_aux_vdev_t  spa_metaspares;		/* meta data hot spares  */
	spa_aux_vdev_t	spa_lowspares;		/* low data hot spares  */
	spa_aux_vdev_t	spa_mirrorspares;	/* morror mode hot spares  */

...
que_init:
	...
	(void) snprintf(base_vha->qla_minor_name, sizeof (base_vha->qla_minor_name),
	    "qla%d", pdev->dev.id);
	(void) snprintf(base_vha->qla_port_alias, sizeof (base_vha->qla_port_alias),
	    "%s,0", base_vha->qla_minor_name);

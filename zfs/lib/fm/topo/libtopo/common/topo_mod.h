...
typedef struct smbios_info smbios_system_t;
typedef struct smbios_info smbios_info_t;
/*
...
#define TOPO_METH_STATUS		"topo_status"
#define TOPO_METH_STATUS_DESC		"status indicator"
...
typedef enum topo_xml_statusno{
		SXML_UNSUPPORTED = 0,
		SXML_OK,		/*  1  */
		SXML_CRITICAL,		/*  2  */
		SXML_NONCRITICAL,	/*  3  */
		SXML_UNRECOVERABLE,	/*  4  */
		SXML_NOT_INSTALLED,	/*  5  */
		SXML_UNKNOWN,		/*  6  */
		SXML_UNAVAI,		/*  7  */
		SXML_NO_ACCESS,		/*  8  */
		SXML_ONLINE,		/*  9  */

 ...
 * xyses xml command
 */
#define XYSES_TOPO_XML_CMD_PRE		"/usr/sbin/xyses_hc"
#define XYSES_TOPO_XML_PLATFORM_PRE	"/usr/platform/"
#define XYSES_TOPO_XML_MAPS_PRE		"/lib/fm/topo/maps/"
#define XYSES_TOPO_XML_HC_POSTFIX		"-hc-topology.xml"
...
extern int topo_warning_xml_print(topo_hdl_t *, FILE *, const char *scheme, int *);

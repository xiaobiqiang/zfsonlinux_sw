...
static const fmd_scheme_ops_t _fmd_scheme_default_ops = {
	(int (*)(void))fmd_scheme_nop,		/* sop_init */
	(void (*)(void))fmd_scheme_nop,		/* sop_fini */
	(ssize_t (*)(nvlist_t *, char *, size_t))fmd_scheme_notsup,	/* sop_nvl2str */
	(int (*)(nvlist_t *))fmd_scheme_nop,		/* sop_expand */
	(int (*)(nvlist_t *))fmd_scheme_notsup,		/* sop_present */
	(int (*)(nvlist_t *))fmd_scheme_notsup,		/* sop_replaced */
	(int (*)(nvlist_t *))fmd_scheme_notsup,		/* sop_service_state */
	(int (*)(nvlist_t *))fmd_scheme_notsup,		/* sop_unusable */
	(int (*)(nvlist_t *, nvlist_t *))fmd_scheme_notsup,		/* sop_contains */

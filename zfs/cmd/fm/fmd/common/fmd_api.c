...
fmd_hdl_register(fmd_hdl_t *hdl, int version, const fmd_hdl_info_t *mip)
{
	...
	if (ops.fmdo_recv == NULL)
		ops.fmdo_recv = (void (*)(fmd_hdl_t *, fmd_event_t *, nvlist_t *, const char *))fmd_hdl_nop;
	if (ops.fmdo_timeout == NULL)
		ops.fmdo_timeout = (void (*)(fmd_hdl_t *, id_t, void *))fmd_hdl_nop;
	if (ops.fmdo_close == NULL)
		ops.fmdo_close = (void (*)(fmd_hdl_t *, fmd_case_t *))fmd_hdl_nop;
	if (ops.fmdo_stats == NULL)
		ops.fmdo_stats = (void (*)(fmd_hdl_t *))fmd_hdl_nop;
	if (ops.fmdo_gc == NULL)
		ops.fmdo_gc = (void (*)(fmd_hdl_t *))fmd_hdl_nop;
	if (ops.fmdo_send == NULL)
		ops.fmdo_send = (int (*)(fmd_hdl_t *, fmd_xprt_t *, fmd_event_t *, nvlist_t *))fmd_hdl_nop;
	if (ops.fmdo_topo == NULL)
		ops.fmdo_topo = (void (*)(fmd_hdl_t *, struct topo_hdl *))fmd_hdl_nop;
...
fmd_module_unregister(fmd_module_t *mp)
{
	...
	fmd_idspace_apply(mp->mod_threads,
	    (void (*)(fmd_idspace_t *, id_t, void *))fmd_module_thrcancel, mp);
